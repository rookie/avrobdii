...
UBYTE process_PID(UBYTE *data, UBYTE *str, UBYTE nStr, UBYTE *str2, UBYTE nStr2)
{
	...
	switch (pid)
	{
		...
		case 0x09:
			...
			break;
		case 0x0A: 
			sprintf(str,"%01.0fkPa",(double)(data[2])*3.0);
			break;
		case 0x0B: 
			sprintf(str,"%01.0fkPa",(double)(data[2]));
			break;
		case 0x0C: 
			sprintf(str,"%01.0f",(double)MAKEWORD(data[2],data[3])/4.0);
			break;
		case 0x0D: 
			sprintf(str,"%01.0fkm/h",(double)(data[2]));
			break;
		case 0x0E: 
			sprintf(str,"%01.0f",((double)(data[2])-128.0)/2.0);
			break;
		case 0x0F: 
			sprintf(str,"%01.0f%cC",OBDII_TEMP(data[2]),0xDF);
			break;
		case 0x10: 
			sprintf(str,"%01.2fg/s",(double)MAKEWORD(data[2],data[3])*0.01);
			break;
		case 0x11: 
		...
		case 0x1C:
			...
			break;
		case 0x1F: 
			sprintf(str,"%0us", MAKEWORD(data[2],data[3]) );
			break;
		case 0x21: 
			sprintf(str,"%0ukm", MAKEWORD(data[2],data[3]));
			break;
		case 0x22: 
			sprintf(str,"%01.2fkPA",(double)MAKEWORD(data[2],data[3])*0.079 );
			break;
		case 0x23: 
			sprintf(str,"%01.0fkPA",(double)MAKEWORD(data[2],data[3])*10.0);
			break;
		case 0x24:
		case 0x25:
		case 0x26:
		...
		case 0x2A:
		case 0x2B: 
			sprintf(str,"%01.3f",(double)MAKEWORD(data[2],data[3])*0.0000305);
			sprintf(str2,"%01.2fV",(double)MAKEWORD(data[2],data[3])*0.000122);
			break;
		case 0x2C: 
			sprintf(str,"%01.1f%%",OBDII_PERCENT(data[2]));
			break;
		...
		case 0x30: 
			...
			break;
		case 0x31: 
			sprintf(str,"%0dkm",MAKEWORD(data[2],data[3]));
			break;
		case 0x32: 
			sprintf(str,"%01.2fPa",((double)(MAKEWORD(data[2],data[3])))*0.25);
			break;
		case 0x33: 
		...
		case 0x3B: 
			sprintf(str,"%01.3f",(double)MAKEWORD(data[2],data[3])*0.0000305);
			sprintf(str2,"%01.3fmA",(double)MAKEWORD(data[2],data[3])*0.00390625);
			break;
		case 0x3C:
		case 0x3D:
		case 0x3E:
		case 0x3F: 
			sprintf(str,"%01.1f%cC",(double)MAKEWORD(data[2],data[3])*0.1,0xDF);
			break;
		case 0x42:
			sprintf(str,"%01.3fV",(((double)(MAKEWORD(data[2],data[3])))*0.001)-40.0);
			break;
		case 0x43:
			sprintf(str,"%01.1f%%abs",((double)(MAKEWORD(data[2],data[3])))*100.0/255.0);
			break;
		case 0x44:
			sprintf(str,"%01.3fs",((double)(MAKEWORD(data[2],data[3])))*0.0000305);
			break;
		case 0x45:
			sprintf(str,"%01.1f%%",OBDII_PERCENT(data[2]));
			break;
		...
		case 0x4C:
			...
			break;
		case 0x4D:
			sprintf(str,"%0ds",MAKEWORD(data[2],data[3]));
			break;
		case 0x4E:
			sprintf(str,"%0ds",MAKEWORD(data[2],data[3]));
			break;
